 ...
 * the License.
 */
package org.terracotta.bigmemory.hadoop.util;
 ...
 */
public class HadoopCompatabilityUtil {
  ...
  static {
    ...
    try {
      ...
      GENERIC_COUNTER_CONSTRUCTOR = genericCounterCls.getDeclaredConstructor(String.class,
    		  																 String.class,
    		  																 Long.TYPE);
      GENERIC_COUNTER_CONSTRUCTOR.setAccessible(true);

      if (useV21) {
        MAP_CONTEXT_CONSTRUCTOR = mapContextCls.getDeclaredConstructor(Configuration.class,
        															   TaskAttemptID.class,
        															   RecordReader.class,
        															   RecordWriter.class,
        ...
        try {
          get_counter_enum = Class.forName(PACKAGE + ".TaskAttemptContext").getMethod("getCounter", Enum.class);
        } catch (Exception e) {
          get_counter_enum = Class.forName(PACKAGE + ".TaskInputOutputContext").getMethod("getCounter", Enum.class);
        }
        ...
        GET_COUNTER_METHOD = Class.forName(PACKAGE+".TaskInputOutputContext").getMethod("getCounter", 
        																				String.class, 
        																				String.class);
        GET_COUNTER_ENUM =  Class.forName(PACKAGE+".TaskInputOutputContext").getMethod("getCounter", 
        																				Enum.class);
      }
      ...
      GET_TASK_CONF =  Class.forName(PACKAGE+".TaskAttemptContext").getMethod("getConfiguration");
      GET_JOB_ID = Class.forName(PACKAGE+".JobContext").getMethod("getJobID");
      GET_CONTEXT_CREDENTIALS = Class.forName(PACKAGE+".JobContext").getMethod("getCredentials");
   ...
   */
  public static Configuration getTaskConfiguration(TaskAttemptContext taskAttemptContext) {
   ...
   * Hadoop 1 and 2.
   */
  public static Counter getCounter(TaskInputOutputContext context, Enum count) {
